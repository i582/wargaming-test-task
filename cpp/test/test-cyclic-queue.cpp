...
{
    test_tasks::cyclic_queue<int, 5> queue1;
...
{
    test_tasks::cyclic_queue<SimpleClass, 5> queue1;
    ...
    test_tasks::cyclic_queue<SimpleClass, 5> queue2(queue1);
    ...
    // move constructor
    test_tasks::cyclic_queue<SimpleClass, 5> queue3(std::move(queue1));
